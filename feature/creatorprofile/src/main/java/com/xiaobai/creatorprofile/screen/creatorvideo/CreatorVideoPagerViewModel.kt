...
import com.xiaobai.domain.creatorprofile.GetCreatorProfileUseCase
import com.xiaobai.domain.creatorprofile.GetCreatorPublicVideoUseCase
...
@HiltViewModel
class CreatorVideoPagerViewModel @Inject constructor(
